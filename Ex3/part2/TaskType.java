...
public enum TaskType {
    COMPUTATIONAL(1){
        @Override
        public String toString(){return "Computational Task͟";}
    },
    IO(2){
        @Override
        public String toString(){return "IO-Bound Task͟";}
    },
    OTHER(3){
        @Override
        public String toString(){return "Unknown Task͟";}
    };
    ...
    private TaskType(int priority){
        if (validatePriority(priority)) typePriority = priority;
            ...
            throw new IllegalArgumentException("Priority is not an integer͟");
    }
